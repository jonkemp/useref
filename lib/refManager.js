...
module.exports = {
  setBuildBlock: function(block, options) {
    ...
    bb.alternateSrcPath = props.alternateSrcPath;
  },
  ...
  getRef: function(block, blockContent, options) {
    ...
    if (bb.type === 'css') {
      ref = this.transformCSSRefs(blockContent, bb.alternateSrcPath ? bb.alternateSrcPath : bb.target, bb.attbs);
    } else if (bb.type === 'js') {
      ref = this.transformJSRefs(blockContent, bb.alternateSrcPath ? bb.alternateSrcPath : bb.target, bb.attbs);
